...
void dgbmv(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	cblas_dgbmv(CLBlastLayoutRowMajor, trans, m, n, kl, ku, alpha, a, lda, x, inc_x, beta, y, inc_y);
}
...
void sgbmv(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	const int inc_y = info[12]->Uint32Value();
	cblas_sgbmv(CLBlastLayoutRowMajor, trans, m, n, kl, ku, alpha, a, lda, x, inc_x, beta, y, inc_y);
}
...
void zgbmv(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	double *y = reinterpret_cast<double*>(info[11].As<v8::Float64Array>()->Buffer()->GetContents().Data());
	const int inc_y = info[12]->Uint32Value();
	cblas_zgbmv(CLBlastLayoutRowMajor, trans, m, n, kl, ku, alpha, a, lda, x, inc_x, beta, y, inc_y);
}
...
void cgbmv(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	float *y = reinterpret_cast<float*>(info[11].As<v8::Float32Array>()->Buffer()->GetContents().Data());
	const int inc_y = info[12]->Uint32Value();
	cblas_cgbmv(CLBlastLayoutRowMajor, trans, m, n, kl, ku, alpha, a, lda, x, inc_x, beta, y, inc_y);
}
