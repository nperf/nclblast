...
void dsbmv(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	cblas_dsbmv(CLBlastLayoutRowMajor, uplo, n, k, alpha, a, lda, x, inc_x, beta, y, inc_y);
}
...
void ssbmv(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	const int inc_y = info[10]->Uint32Value();
	cblas_ssbmv(CLBlastLayoutRowMajor, uplo, n, k, alpha, a, lda, x, inc_x, beta, y, inc_y);
}
